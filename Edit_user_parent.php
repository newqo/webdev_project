    ...
    if($status == 0 || $status == 2){ // father
        ...
        $father .="</select>
                    ...
                    <div class='form-group'>
                        ...
                        <input type='text' id='firstname_father' name='father_fst_name' pattern='[A-Za-zก-๙\s]{1,50}' value='". $ft_data['firstname'] ."'>
                    </div>
                    <div class='form-group'>
                        <label>นามสกุล</label>
                        <input type='text' id='lastname_father' name='father_lst_name' pattern='[A-Za-zก-๙\s]{1,50}'  value='". $ft_data['lastname'] ."'>
                    </div>
                    <div class='form-group'>
                        ...
                        <div class='form-group'>
                            <label>อาชีพ</label>
                            <input type='text' id='job_detail_father' name='father_career' pattern='[A-Za-zก-๙\s]{1,50}'  value='". $ft_data['career'] ."'>
                        </div>
                        <div class='form-group'>
    ...
    <!-- ส่วนข้อมูลของมารดา -->
        ...
        $mother .="
                ...
                <div class='form-group'>
                    ...
                    <label>ชื่อจริง</label>
                    <input type='text' id='firstname_mother' name='mother_fst_name' pattern='[A-Za-zก-๙\s]{1,50}' value='". $mt_data['firstname'] ."'>
                </div>
                <div class='form-group'>
                    <label>นามสกุล</label>
                    <input type='text' id='lastname_mother' name='mother_lst_name' pattern='[A-Za-zก-๙\s]{1,50}'  value='". $mt_data['lastname'] ."'>
                </div>
                <div class='form-group'>
                    <label>เบอร์โทร</label>
                ...
                <div class='form-group'>
                        <label>อาชีพ</label>
                        <input type='text' id='job_detail_mother' name='mother_career' pattern='[A-Za-zก-๙\s]{1,50}' value='". $mt_data['career'] ."'>
                    </div>
                    <div class='form-group'>
    ...
    <!-- ส่วนข้อมูลของผู้ปกครอง -->
        ...
        $guardian .="</select>
                ...
                <div class='form-group'>
                    ...
                    <label>ชื่อจริง</label>
                    <input type='text' id='firstname_guardian' name='guardian_fst_name' [A-Za-zก-๙\s]{1,50}' value='". $gd_data['firstname'] ."'>
                </div>
                <div class='form-group'>
                    <label>นามสกุล</label>
                    <input type='text' id='lastname_guardian' name='guardian_lst_name' [A-Za-zก-๙\s]{1,50}' value='". $gd_data['lastname'] ."'>
                </div>
                <div class='form-group'>
                    <label>เบอร์โทร</label>
                ...
                <div class='form-group'>
                        <label>อาชีพ</label>
                        <input type='text' id='job_detail_guardian' name='guardian_career' pattern='[A-Za-zก-๙\s]{1,50}' value='". $gd_data['career'] ."'>
                    </div>
                    <div class='form-group'>
          ...
          <div class="menu-bar">
            ...
            <div id="sidebar-mobile" class="sidenav">
              ...
              <div class="section-title-menu-mobile">หมวดหมู่</div>
                ...
                ?>
              <br/>
              <a href="logput.php">ออกจากระบบ</a>
            </div>
        ...
        <form action='update_user_parents.php' method='post'>
            ...
            ?>
             <div class="submit-btn">
                ...
                <a href='accountpage.php?content=parents' class='cancel-btn' id='edit_user_info'>ยกเลิก</a>
            <div>
        </form>
        </article>
      </div>
