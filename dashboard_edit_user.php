...
<body>
    ...
    <form action="edit_user_procedure.php" method="post">
        ...
        <div class="form-group">
            <label>อีเมลล์</label>
            <input type="text" name="Email" value="<?=$row["อีเมลล์"]?>"required>
        </div>
        <div class="form-group">
            <label>เบอร์โทรศัพท์</label>
            <input type="text" name="phone_num" value="<?=$row["เบอร์โทรศัพท์"]?>"required>
        </div>
        <div class="form-group">
            <label>วันเดือนปีเกิด</label>
            <input type="text" name="birthdate" value="<?=$row["วันเดือนปีเกิด"]?>"required>
        </div>
        <div class="form-group">
            <label>ที่อยู่</label>
            <input type="text" name="Address" value="<?=$row["ที่อยู่"]?>"required>
        </div>
